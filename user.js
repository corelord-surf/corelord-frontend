document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    ...
    document.getElementById("userEmail").textContent = sessionStorage.getItem("userEmail") || profile.email || "Not available";
    ...
    document.getElementById("profileSection").innerHTML = `
      <p class="text-red-600">Failed to load profile. Please try again later.</p>
    `;
  }
});
